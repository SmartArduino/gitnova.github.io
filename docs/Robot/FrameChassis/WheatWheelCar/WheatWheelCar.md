...
The car is made of aluminum alloy chassis, featuring omni-directional movement, fast speed and heavy load. It supports the development board of Arduino, 51, STM32 and Raspberry Pie, and can be controlled by WiFi, Bluetooth and PS2 controller. It is very suitable for DIY, ROS and drift study
...
### 2.2 Mounting Motor Bracket

Take out 16 M3*8 and 16 M3 nuts each and fix the bracket on the chassis as shown in the figure below

![img](wps3.jpg) 

### 2.3  Install the Motor

Take out 12 M3*8 screws and fix the motor on the bracket as shown in the figure below

 

![img](wps4.jpg) 

### 2.4 Install the Wheat Wheel

![img](wps5.jpg) 

The direction of screws fixing the motor should be aligned with the motor shaft notch

![img](wps6.jpg) 

### 2.5 Pay Attention To The Point

Since the wheel-wheel can rotate in all directions, the installation direction should be specified, as shown in the figure below

![img](wps7.jpg) 

![img](wps8.jpg) 

### 2.6 Install LED lights
...
If you cannot find the libraries while compiling the program, please download the libraries file and unzip it to the Libraries folder in the Arduino IDE installation directory：https://github.com/SmartArduino/Arduino-Third-party-Libraries

### 3.1 WiFi/Bluetooth controller

APP control software (Android phone only)：https://github.com/SmartArduino/SmartArduino.github.io/blob/master/docs/Robot/Controller/app/base.apk

Download the source code：https://github.com/SmartArduino/Arduino-Code/blob/master/McNameeWheelCar.rar

Special note: WiFi and Bluetooth control share one program
...
### 3.2 PS2 Handle Control Program
