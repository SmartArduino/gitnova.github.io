...
// Stop
  ...
  if(ps2x.Button(PSB_L1)||ps2x.Button(PSB_R1)){
      ...
      if(pt1){
       if((RY<100)&&(pulselen_1>=SERVOMIN)){//
       Servo0_12(pulselen_1,1);
       pulselen_1=pulselen_1-6;

     }
       else if((RY>=150)&&(pulselen_1<=SERVOMAX)){//
      ...
      if(pt2){
       if((RY<100)&&(pulselen_2<=SERVOMAX)){//
       Servo1_12(pulselen_2,2);
       pulselen_2=pulselen_2+6;

     }
     else if((RY>=150)&&(pulselen_2>=SERVOMIN))
     {//
     ...
     if(pt3){
       if((RY<100)&&(pulselen_3>=SERVOMIN)){//
       Servo0(pulselen_3,3);
       pulselen_3=pulselen_3-6;

     }
       else if((RY>=150)&&(pulselen_3<=SERVOMAX)){//
       Servo1(pulselen_3,3);
       pulselen_3=pulselen_3+6;
...
void Control()
{
  switch(Drive_Num)
  {
    ...
    case GO_LEFT:    left(speed);    break;
    case GO_RIGHT:   right(speed);   break;
