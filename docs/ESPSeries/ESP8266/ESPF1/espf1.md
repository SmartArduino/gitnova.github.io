<center> <font size=10> User Manual for ESP-F1 </font></center>
...
| 13   | IO4  | I/O  | GPIO4                                                        |
| 14   | IO5  | I/O  | GPIO5                                                        |
| 15   | RXD  | I/O  | GPIO3; used to write Flash as UART Rx                        |
| 16   | TXD  | I/O  | GPIO1; used to write Flash as UART Tx                        |
| 17   | LNA  | -    | Antenna pins (for: without IPEX connectors)                  |
...
| Length | Width | Height | PAD  (bottom) | Distance between Pins |
| ------ | ----- | ------ | ------------- | --------------------- |
